...
class WalletConfiguration extends Component {
  ...
  resetRvnbox(configuration) {
    this.props.resetRvnbox(configuration);
    this.setState({
      redirect: true
    })
  }
  ...
  handleConfigChange(e) {
    ...
    if(e.target.id === 'newMnemonic') {
      ...
      if(val === '') {
        ...
        msg = rvnbox.Mnemonic.validate(val, rvnbox.Mnemonic.wordLists()[this.props.configuration.wallet.language]);
      }
  ...
  render() {
    ...
    if(!this.props.configuration.wallet.autogenerateHDMnemonic && this.props.configuration.wallet.mnemonicValidationMsg !== 'Valid mnemonic') {
      ...
      restartBtn = <button className="pure-button" onClick={this.resetRvnbox.bind(this, this.props.configuration.wallet)}><FontAwesomeIcon icon={faRedo} /> Restart</button>
    }
          ...
          <div className="l-box-lrg pure-u-1-2">
            <form className="pure-form pure-form-stacked" onSubmit={this.handleSubmit}>
              <fieldset>
                ...
                <label htmlFor='displayRvnaddr'>Display in Rvnaddr format</label>
                <Toggle
                  id='displayRvnaddr'
                  defaultChecked={this.props.configuration.wallet.displayRvnaddr}
                  onChange={this.props.handleConfigToggle.bind(this)} />
